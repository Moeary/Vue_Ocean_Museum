  ...
  setup(props) {
    ...
    const allEvents = [
      ...
      createTimelineEvent({
        ...
        color: '#9B59B6',
        detailedDescription: `明朝永乐年间至宣德年间，郑和奉命率领当时世界上最庞大的航海舰队，先后七次下西洋。舰队由数百艘宝船组成，人员最多时达两万多人。郑和的航迹遍及东南亚、印度洋、阿拉伯海、甚至到达非洲东海岸。<br/><br/>
        郑和下西洋的目的包括宣扬国威、进行贸易和寻找失踪的建文帝等。他的舰队携带了大量的丝绸、瓷器、茶叶等中国商品，与沿途各国进行贸易和文化交流。郑和的航行促进了中国与亚非国家之间的交流, 经济和文化联系。<br/><br/>
        郑和下西洋展示了明朝强大的经济实力和先进的造船、航海技术。他的远航比欧洲大航海时代早了半个多世纪，是世界航海史上的伟大壮举，体现了中国古代航海事业的辉煌成就。`,
        detailImages: [
          {
      ...
      createTimelineEvent({
        date: '公元1519年 - 1522年',
        title: '麦哲伦环球航行',
        description: '葡萄牙航海家麦哲伦率领的船队首次完成环球航行，证明了地球是圆形的，极大地拓展了人类的航海视野。',
        image: '/images/magellan-circumnavigation.jpg',
        color: '#A9CCE3',
        detailedDescription: `1519年，葡萄牙航海家费尔南多·麦哲伦受西班牙国王查理五世派遣，率领的船队，试图从好望角方向到达香料群岛（摩鹿加群岛）。这次航行历时三年，途中麦哲伦在菲律宾去世，最终由他的船员胡安·塞巴斯蒂安·埃尔卡诺完成环球航行。<br/><br/>
        麦哲伦船队经历了重重困难，包括风暴、饥饿、疾病和与土著居民的冲突。他们穿越了大西洋、太平洋和印度洋，首次完成了环球航行，用实践证明了地球是圆形的。这次航行极大地拓展了人类的地理知识和航海视野，开启了全球大航海时代。<br/><br/>
        虽然麦哲伦环球航行的商业回报有限，但其历史和科学意义非常重大。它标志着人类海洋探险打到了新的高度，也为后来的三角贸易和殖民扩张奠定了基础。`,
        detailImages: [
          {
